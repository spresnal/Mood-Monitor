package com.example.sam.moodalert.Library;
...
public class FloatingActionButtonFragment extends View {
    ...
    public FloatingActionButtonFragment(Context context) {
        super(context);
    ...
    static public class Builder {
         ...
         * @return fab button
         */
        public FloatingActionButtonFragment create() {
            final FloatingActionButtonFragment button = new FloatingActionButtonFragment(activity);
